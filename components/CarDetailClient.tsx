  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <nav className="flex items-center space-x-2 text-sm text-gray-500 mb-4">
        ...
        <span>/</span>
        <button onClick={() => router.push(`/cities/${car.city}`)} className="hover:text-blue-600">{car.city}</button>
        <span>/</span>
      ...
      <div className="grid lg:grid-cols-3 gap-8">
              ...
              <>
                ...
                {photos.length > 1 && (
                  <>
                    <button
                      onClick={prevPhoto}
                      className="absolute left-3 top-1/2 -translate-y-1/2 bg-white/90 hover:bg-white shadow-md rounded-full p-2 transition opacity-0 group-hover:opacity-100"
                    >
                      <ChevronLeft className="w-5 h-5" />
                    </button>
                    <button
                      onClick={nextPhoto}
                      className="absolute right-3 top-1/2 -translate-y-1/2 bg-white/90 hover:bg-white shadow-md rounded-full p-2 transition opacity-0 group-hover:opacity-100"
                    >
                ...
                <button
                  ...
                  className="absolute top-4 right-4 p-2 rounded-full bg-white/80 hover:bg-white shadow-sm transition"
                >
              ...
              {photos.map((photo, idx) => {
                ...
                return (
                  <button
                    ...
                    className={`relative w-20 h-16 flex-shrink-0 rounded-lg overflow-hidden border-2 transition ${
        ...
        <div className="space-y-6">
          {/* Цена и быстрые действия */}
          <div className="bg-white p-6 rounded-2xl shadow-sm border">
            <div className="flex items-baseline justify-between">
              <div>
                <span className="text-3xl font-bold text-gray-900">{car.price_per_day} ₽</span>
            ...
            {car.buyout_price && (
              <div className="mt-3 flex items-center text-emerald-700 bg-emerald-50 px-3 py-2 rounded-lg">
                ...
                <span className="font-medium">Выкуп: {car.buyout_price} ₽</span>
              </div>
            )}
            ...
            <div className="mt-4 space-y-3">
                ...
                <>
                  {car.user?.phone && (
                    <a
                      ...
                      className="flex items-center justify-center gap-2 w-full bg-blue-600 text-white py-3 rounded-xl hover:bg-blue-700 transition font-medium"
                    >
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-2 w-full bg-green-600 text-white py-3 rounded-xl hover:bg-green-700 transition font-medium"
                  >
              ...
              {!user && (
                <button
                  ...
                  className="flex items-center justify-center gap-2 w-full bg-blue-600 text-white py-3 rounded-xl hover:bg-blue-700 transition"
                >
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="text-xs text-gray-500">Просмотров сегодня</p>
                  <p className="font-medium">{viewsToday}</p>
                </div>
              </div>
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="font-medium text-green-600">Да</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border">
            ...
            <div className={`whitespace-pre-line text-gray-700 ${!showFullDescription && isLongDescription ? 'max-h-32 overflow-hidden relative' : ''}`}>
              {description}
            ...
            <div className="bg-amber-50 p-6 rounded-2xl border border-amber-200">
              ...
              <div className="space-y-2">
                <button
                  ...
                  className="flex items-center gap-2 w-full bg-white text-gray-700 py-2.5 px-4 rounded-xl hover:bg-gray-50 transition border"
                >
                  <Edit3 className="w-4 h-4" /> Редактировать
                </button>
                <button
                  onClick={() => router.push(`/cars/${car.id}/edit?tab=photos`)}
                  className="flex items-center gap-2 w-full bg-white text-gray-700 py-2.5 px-4 rounded-xl hover:bg-gray-50 transition border"
                >
                ...
                <button
                  ...
                  className="flex items-center gap-2 w-full bg-red-50 text-red-600 py-2.5 px-4 rounded-xl hover:bg-red-100 transition border border-red-200"
                >
