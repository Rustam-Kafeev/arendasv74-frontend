...
import {
  Car, Plus, MessageSquare, Eye, TrendingUp,
...
export default function DashboardClient() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      {/* Заголовок без большого аватара */}
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        <div className="bg-white rounded-2xl shadow-sm border p-5">
          <div className="flex items-center justify-between">
            <span className="text-sm text-gray-500">Активных объявлений</span>
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-emerald-500 to-emerald-600 flex items-center justify-center">
              <TrendingUp className="w-5 h-5 text-white" />
            </div>
          </div>
          <p className="text-3xl font-bold mt-3">{stats?.active_cars || 0}</p>
          <p className="text-xs text-gray-400 mt-1">доступно сейчас</p>
        </div>
      </div>
